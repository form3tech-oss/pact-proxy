...
func (s *ProxyStage) a_request_is_sent_in_plain_text(pact string) {
	s.a_request_is_sent_in_plain_text_with_body(pact, "text")
}

func (s *ProxyStage) a_request_is_sent_in_plain_text_with_body(pact string, body string) {
	s.a_request_is_sent_with_body_and_content_type(pact, body, "text/plain")
}

func (s *ProxyStage) a_request_is_sent_with_body_and_content_type(pact, body, contentType string) {
	s.pactResult = s.pact.Verify(func() (err error) {
		i := s.proxy.
			ForInteraction(pact)
